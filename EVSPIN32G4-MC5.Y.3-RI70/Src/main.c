...
uint8_t g_reg_C = 0;
uint8_t g_reg_80 = 0;
uint8_t g_gd_nfault = 0;
uint8_t g_gd_ready = 0;
...
//
//		g_current_encoder_position_in_rad = M_TWOPI * (double) g_current_encoder_position / ENCODER_M1.PulseNumber;
//		g_current_joint_position_in_rad = fmod(g_current_encoder_position_in_rad / 121, M_TWOPI) - M_PI;
//
//		uint8_t register_pointer = 0x80;
//	    HAL_I2C_Master_Transmit(&hi2c3, 0b10001110, &register_pointer, 1, 100);
//	    HAL_I2C_Master_Receive(&hi2c3,  0b10001110, &g_reg_80, sizeof(g_reg_1), 100);
//
//	    register_pointer = 0x08;
//	    HAL_I2C_Master_Transmit(&hi2c3, 0b10001110, &register_pointer, 1, 100);
